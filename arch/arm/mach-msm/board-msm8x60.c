...
#if defined(CONFIG_SKY_SMB136S_CHARGER) || defined(CONFIG_SKY_SMB137B_CHARGER)
	if (machine_is_msm8x60_fluid()|| machine_is_msm8x60_ef65l())
	{
		if (init)
...
#if defined(CONFIG_SKY_BATTERY_MAX17040) || defined(CONFIG_SKY_BATTERY_MAX17043) //p14682 kobj 110607ps2 team shs : fuel gauge porting
...
#if defined(CONFIG_INPUT_PANTECH_EARJACK) && defined(CONFIG_MACH_MSM8X60_EF65L) // N1037 20120330 for ICS EarJack 
...
static struct platform_device *surf_devices[] __initdata = {
...
#endif	//CONFIG_SKY_BATTERY_MAX17040
#if 0 //2011_10_27 duplicate regstration
#if defined(CONFIG_SPI_QUP) || defined(CONFIG_SPI_QUP_MODULE)
	...
	&msm_device_uart_dm1,
#endif
#ifdef CONFIG_MSM_SSBI		//jwchoi_temp_
...
static void __init reserve_pantech_debug_memory(void)
{
#if defined(CONFIG_PANTECH_DEBUG)
	unsigned long debug_buf_size;

	debug_buf_size = sizeof(struct pantech_debug_log);

	debug_buf_size += (PAGE_SIZE-1);
	debug_buf_size &= (~(PAGE_SIZE-1));

	msm8x60_reserve_table[MEMTYPE_EBI1].size += debug_buf_size;
#endif
}
...
#endif
#if 0 //defined(CONFIG_SMB137B_CHARGER) || defined(CONFIG_SMB137B_CHARGER_MODULE)
	{
		I2C_FLUID,
		MSM_GSBI8_QUP_I2C_BUS_ID,
...
//#endif
	...
	if (machine_is_msm8x60_fluid()) {
#if (defined(CONFIG_USB_EHCI_MSM_72K) && \
    (defined(CONFIG_SKY_SMB_CHARGER) || \
	 defined(CONFIG_SKY_SMB136S_CHARGER) || \
	 defined(CONFIG_SKY_SMB137B_CHARGER)))
...
//[BIH] 8058_L15 voltage changed from 2850000 to 2800000 because voltage value upper limit exceed problem.
//	sdcc_vreg_data[2].vdd_data->level = 2850000;
	sdcc_vreg_data[2].vdd_data->level = 2800000;
...
// 201110422, kkcho,  for MHL-power
	...
	return 0;
#ifdef PANTECH_MHL_SII9244_POWER_CTRL  // 20110516, kkcho, remove for MHL Device.
error3:
	gpio_free(172);
error2:
	gpio_free(171);
...
*/
	...
	if (machine_is_msm8x60_ffa() || machine_is_msm8x60_fusn_ffa() ||
		machine_is_msm8x60_dragon()
#ifdef CONFIG_MACH_MSM8X60_EF65L //ST_LIM_0816 ���� ���� �ȵǴ� ���� ����.
		|| machine_is_msm8x60_ef65l()
#endif
	) {
...
#if defined(CONFIG_SKY_SMB136S_CHARGER) || defined(CONFIG_SKY_SMB137B_CHARGER)	//jwchoi_temp
    smb137b_hw_init();
