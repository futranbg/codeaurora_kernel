...
// RMNET Issue, Lee, Younhee, 13/01/08
...
// RMNET Issue, Lee, Younhee, 13/01/08
	...
	if(!b_qualcomm_usb_mode && b_pantech_usb_module){
		rmnet_mux_interface_desc.bInterfaceClass =      USB_CLASS_VENDOR_SPEC;
		rmnet_mux_interface_desc.bInterfaceSubClass =   0xF0;
		rmnet_mux_interface_desc.bInterfaceProtocol =   0x00;
	}else{
		rmnet_mux_interface_desc.bInterfaceClass =      USB_CLASS_VENDOR_SPEC;
		rmnet_mux_interface_desc.bInterfaceSubClass =   USB_CLASS_VENDOR_SPEC;
		rmnet_mux_interface_desc.bInterfaceProtocol =   USB_CLASS_VENDOR_SPEC;
	}
    #endif
