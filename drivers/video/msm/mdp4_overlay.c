...
#ifdef CONFIG_F_SKYDISP_BUG_FIX_MDP_DOWNSCALING/*for HDMI bug(underrunning) on portrait mode (video)*/
...
#ifndef CONFIG_F_SKYDISP_BUG_FIX_MDP_DOWNSCALING  /* 1521 base */
